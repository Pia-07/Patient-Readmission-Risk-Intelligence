...
def transform_bronze_to_silver() -> int:
    ...
    silver_df = pd.DataFrame({
        ...
        'diag_2_category': df['diag_2_category'],
        'diag_3_category': df['diag_3_category'],
        ...
        'medication_change': df['medication_change'],
        'high_lab_procedures': df['high_lab_procedures'],
        'total_medications_active': df['total_medications_active'].astype(int),
